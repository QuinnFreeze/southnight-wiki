...
@php($authPage=request()->routeIs('login') || request()->routeIs('register') || request()->routeIs('account.recovery') || request()->routeIs('account'))
...
@php($minimalFooter=request()->routeIs('announcements.*')||request()->routeIs('settings')||request()->routeIs('account*'))
